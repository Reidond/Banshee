...
Invoke the `task-learnings` skill (`.Codex/skills/task-learnings/SKILL.md`) to:
...
6. **If any AI infrastructure files were modified** during steps 1–7 (convention updates,
   skill modifications, rule additions), read `.Codex/skills/ai-changelog/SKILL.md` and
   append the appropriate changelog entry to `.ai/ai-changelog.md`
7. **After writing a changelog entry**, read `.Codex/skills/ai-improvement-tracker/SKILL.md`
