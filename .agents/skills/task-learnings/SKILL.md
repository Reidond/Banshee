...
| Convention ambiguity resolved | Relevant project rule files (`.Codex/skills/`, AGENTS.md, or equivalent) | Add clarification |
| Skill instructions were insufficient | Relevant `.Codex/skills/*/SKILL.md` | Extend instructions |
...
read `.Codex/skills/ai-changelog/SKILL.md` and append the appropriate changelog entry
...
After writing a changelog entry in Step 7, read `.Codex/skills/ai-improvement-tracker/SKILL.md`
