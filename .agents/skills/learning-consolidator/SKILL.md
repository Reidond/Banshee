...
| `.Codex/skills/*/SKILL.md` | Grep for the pattern or rule described |
...
3. **Create the skill following the `skill-creator` pipeline**
   (see `.Codex/skills/skill-creator/SKILL.md` for the full 5-phase process):
   - Phase 1 (Discovery): answers come from the clustered learnings
   - Phase 2 (Classification): use the skill taxonomy from `.Codex/skills/skill-reviewer/references/skill-taxonomy.md`
   - Phase 3 (Build): create SKILL.md, references/ files as needed
   - Phase 4 (Validation): run the structural compliance checklist
   - Phase 5 (Registration): add to AGENTS.md
4. **Validate quality using the `skill-reviewer` checklist**
   (see `.Codex/skills/skill-reviewer/references/review-checklist.md`):
...
2. **Skill consistency** — For each new or updated skill:
   - Verify it's listed in AGENTS.md
...
**7a. Append changelog entry** — Read `.Codex/skills/ai-changelog/SKILL.md` and append a
...
**7b. Record improvement hypothesis** — Read `.Codex/skills/ai-improvement-tracker/SKILL.md`
