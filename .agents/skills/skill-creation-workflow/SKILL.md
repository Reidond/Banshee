...
Read `.Codex/skills/skill-researcher/SKILL.md`, then use the **Agent tool** to
...
1. Read `.Codex/skills/skill-creator/SKILL.md`
...
1. Read `.Codex/skills/skill-reviewer/SKILL.md`
2. Read `.Codex/skills/skill-reviewer/references/review-checklist.md`
3. Execute Steps 1–8 of Review Mode against the new skill:
   ...
   - **Step 6:** Instruction quality + Codex feature usage
...
Read `.Codex/skills/skill-content-reviewer/SKILL.md`, then use the **Agent tool**
...
Agent (skill-content-reviewer):
  ...
  prompt: "You are the Skill Content Reviewer. Here is your skill definition:
    ...
    Skill directory: .Codex/skills/{skill-name}/
    Research Brief:
...
Follow the `skill-creator`'s Phase 5 (Registration) to add the skill to `AGENTS.md`,
