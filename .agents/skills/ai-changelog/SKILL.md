...
- AGENTS.md skill listings are updated
...
| `INFRA-MODIFIED` | Changes to AI infrastructure files or AGENTS.md listings |
...
- **One entry per logical change** — if a single task creates a skill AND updates AGENTS.md, that's one entry with both files listed. If a consolidation promotes 3 different learnings to 3 different rules, that's 3 entries.
...
- **Files:** AGENTS.md, .Codex/skills/openai-realtime-quirks/SKILL.md, .ai/learnings.md, AGENTS.md
...
- **What:** Created `.Codex/skills/ai-changelog/` to track all AI infrastructure changes in a structured changelog
- **Why:** Enable historical tracking and learning from how the AI infrastructure evolves over time
- **Files:** `.Codex/skills/ai-changelog/SKILL.md`, `.ai/ai-changelog.md`, `AGENTS.md`
