...
`platform.openai.com`, `platform.Codex.com` vs `docs.anthropic.com`). Substituting the
...
| Codex / Anthropic specifics | Model IDs, tool use format, system prompt handling, pricing |
...
| Source | URL | Use for |
|---|---|---|
| Codex docs home | `https://platform.Codex.com/docs/en/home` | Navigation starting point, all Codex docs |
| Models overview | `https://docs.anthropic.com/en/docs/about-Codex/models/overview` | Model IDs, context windows, capabilities |
| Tool use guide | `https://docs.anthropic.com/en/docs/build-with-Codex/tool-use` | Function/tool calling format |
| Codex API reference | `https://docs.anthropic.com/en/api/messages` | Messages API schema |
