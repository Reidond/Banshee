...
- **Acceptance criteria**:
  - [ ] Read-lock variant implemented behind the `snapshot` contract
  - [ ] Flood profile captured; if UI-stall/latency gates fail, snapshot variant implemented and measured
  - [ ] Decision + numbers logged in design Deviations Log and SPEC §15 Q2
